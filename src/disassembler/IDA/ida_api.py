...
class IDA(DisasAPI):
    ...
    def configForm(self):
        ...
        #config_values = { 'is_windows':False,'config_path':'/home/dgramop/Karta/configs'}
        #probably best if it errors out
